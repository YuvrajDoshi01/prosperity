...
# --- ACO Parameters (LU-style, same as v8) ---
...
class Trader:
    ...
    def _ipr(self, book: OrderDepth, pos, prev_mids, slope, directions):
        ...
        if indicator >= 0.5:
            ...
            if pos <= 0.9 * target:
                # Aggressive lift from tick 0 — no warmup gate
                # IPR drifts +1000/day, every tick at <80 is missed drift
                ...
                # Careful accumulation near target
