...
# From v10: removed spread-signal overlay (overfitting), added clear step (+3%),
# added soft-limit inventory skew at |pos| > 40.
...
# --- IPR Parameters (228959 trend-following, WITH warmup gate from v8) ---
...
class Trader:
    ...
    def _aco(self, state):
        ...
        # Inventory skew: tighten reducing side, widen extending side
    ...
    # === IPR: 228959 trend-following (WITH warmup gate, from v8) ===
    ...
    def _ipr(self, book: OrderDepth, pos, prev_mids, slope, directions):
        ...
        if indicator >= 0.5:
            ...
            # v8 warmup gate: wait for 5-tick history before aggressive lift
            ...
            # Intentional long-bias: len(prev_mids)==10 never true (capped at 5)
