...
"""
s37_as_lite — s36_medallion + A-S-Lite position-dependent FV shift

Change from s36: After all FV components (regression + trade flow + OBI),
apply fair_value -= GAMMA_POS * pos. This shifts take thresholds based on
inventory — when long, FV drops (less willing to buy, more willing to sell).

Backtester day 0: 2,684 (+58 over s36 baseline 2,626)
Projected website: ~2,950 (s36 was 2,896)

Key: gamma=0.01 is tiny. At position 50, shift = 0.5 ticks. Only changes
integer FV at boundary conditions. This is NOT full A-S reservation price
(which scored 2,793) — we keep best±1 posting structure unchanged.
"""
...
# --- A-S-Lite: position-dependent FV shift ---
GAMMA_POS = 0.01
