...
"""
s2_speed_flat: Ultra-optimized s2_tradeflow — IDENTICAL logic, maximum speed.
No ABC, no deque, no class hierarchy. Everything inline.
Liquidation tracking preserved (it affects EMERALDS PnL).
"""
