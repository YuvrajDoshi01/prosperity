...
"""
s74_amp02 — s74_ema_carry sweep variant
Changed: EMA_AMP_FACTOR = 0.2 (weaker amplification vs base 0.3)
"""
...
EMA_AMP_FACTOR = 0.2          # CHANGED: weaker amplification (base 0.3)
