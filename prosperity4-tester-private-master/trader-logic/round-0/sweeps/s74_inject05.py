...
"""
s74_inject05 — s74_ema_carry sweep variant
Changed: EMA_INJECT_STRENGTH = 0.5 (weaker inject vs base 0.7),
         EMA_INJECT_THRESHOLD = 5.0 (earlier inject vs base 6.0)
"""
...
EMA_INJECT_THRESHOLD = 5.0    # CHANGED: earlier inject (base 6.0)
EMA_INJECT_STRENGTH = 0.5     # CHANGED: weaker inject (base 0.7)
