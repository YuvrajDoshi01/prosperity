...
"""
s74_alpha02 — s74_ema_carry sweep variant
Changed: EMA_ALPHA = 0.02 (faster EMA, ~50-tick lookback vs base 0.01 ~100-tick)
"""
...
EMA_ALPHA = 0.02              # CHANGED: faster EMA (~50-tick lookback)
