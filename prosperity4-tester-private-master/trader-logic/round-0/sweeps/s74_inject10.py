...
"""
s74_inject10 — s74_ema_carry sweep variant
Changed: EMA_INJECT_STRENGTH = 1.0 (stronger inject vs base 0.7),
         EMA_INJECT_THRESHOLD = 8.0 (later inject vs base 6.0)
"""
...
EMA_INJECT_THRESHOLD = 8.0    # CHANGED: later inject (base 6.0)
EMA_INJECT_STRENGTH = 1.0     # CHANGED: stronger inject (base 0.7)
