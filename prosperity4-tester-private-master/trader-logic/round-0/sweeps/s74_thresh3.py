...
"""
s74_thresh3 — s74_ema_carry sweep variant
Changed: EMA_AMP_THRESHOLD = 3.0 (trigger earlier vs base 4.0)
"""
...
EMA_AMP_THRESHOLD = 3.0       # CHANGED: trigger earlier (base 4.0)
