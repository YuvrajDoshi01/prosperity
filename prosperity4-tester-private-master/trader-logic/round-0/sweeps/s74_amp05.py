...
"""
s74_amp05 — s74_ema_carry sweep variant
Changed: EMA_AMP_FACTOR = 0.5 (stronger amplification vs base 0.3)
"""
...
EMA_AMP_FACTOR = 0.5          # CHANGED: stronger amplification (base 0.3)
