...
"""
s74_alpha005 — s74_ema_carry sweep variant
Changed: EMA_ALPHA = 0.005 (slower EMA, ~200-tick lookback vs base 0.01 ~100-tick)
"""
...
EMA_ALPHA = 0.005             # CHANGED: slower EMA (~200-tick lookback)
