"""r4_yolo_c_stack_short.py — Candidate C: STACKED short everything.
VFE -200 + ALL vouchers -300 + HP -200. Theoretical ceiling ~$60k+ on day3 1k."""
import json
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for sym, target in TARGETS.items():
            ...
            if not od: continue
            qty = pos - target  # need to sell this many
            if qty <= 0: continue
            if not od.buy_orders: continue
