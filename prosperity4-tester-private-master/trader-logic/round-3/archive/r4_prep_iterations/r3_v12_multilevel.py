"""r3_v12.py — v11 + multi-level passive posting on VFE + vouchers (Phase 1.1).

Phase 1.1 from R4-prep roadmap (alpha A3, EV +$11k 3-day per alpha_hunt Q2):
  - VFE Wall Mid MM: replace single-level post with 3-layer (40/30/30)
  - Voucher MM (5000-5400): replace single-level post with 3-layer (40/30/30)
  - HP passive MM: UNCHANGED (preserve spread=17 GIGA SHORT alpha; multi-level
    on HP risks interfering with the position-aggression logic that drives
    $10k of the $12k 1k-tick day 2 PnL)
  - HP take and voucher take: ALREADY multi-level (iterate sorted asks/bids)

Baseline (v11): 1k-tick day 2 = $12,262, 10k 3-day = $46,976.
Expected v12: +$300-1500 1k-tick day 2 from improved fill rate on VFE/vouchers.

Inherits all v11 documentation below.
=====================================================================
