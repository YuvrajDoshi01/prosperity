"""r3_combined_v23.py — v22 + drawdown reduction + voucher cleanup.
...
V_BS_STRIKES = [5000, 5100, 5200, 5300, 5400]  # v23: removed 5500 (net $0 in training, -$97 website)
V_BS_EDGE_MAP = {
...
OTM_BID_PARAMS = {
    5300: {"size": 20, "cap": 100, "edge": 1},  # v23: halved from 200 (0.08 reward/risk)
