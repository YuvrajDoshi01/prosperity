...
"""
r1_v15_anchor_bootstrap — r1_v14_defensive with only one conceptual change:

ACO anchor fix:
- Do NOT assume ACO starts at 10000.
- Bootstrap anchor from first valid two-sided ACO snapshot.
- Then update anchor slowly from persistent median shift.
- Keep all other ACO / IPR logic unchanged.

Everything else is intentionally kept the same as v14.
"""
...
class Trader:
    ...
    def _aco(self, state):
        ...
        if has_bids and has_asks:
            ...
            # Long window for slow anchor updates
